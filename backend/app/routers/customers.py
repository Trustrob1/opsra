...
def get_customer_messages(
    ...
    try:
        ...
        logger.warning("sent_by_name enrichment failed for customer %s: %s", customer_id, _exc)
    ...
    try:
        ...
        logger.warning("reply_preview enrichment failed for customer %s: %s", customer_id, _exc)
